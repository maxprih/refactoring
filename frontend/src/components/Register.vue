<template>
  <div class="col-md-12 text-center" data-bs-theme="dark">
    <div class="card card-container">
      ...
      <Form @submit="handleRegister" :validation-schema="schema">
        <div v-if="!successful">
          ...
          <div class="form-group">
            <label class="h4" for="confirm_password">Confirm password</label>
            <Field name="confirm_password" type="password" class="form-control" />
            <ErrorMessage name="confirm_password" class="error-feedback" />
          </div>

          <div class="form-group">
            <button style="margin-top: 30px; width: 50%;" class="btn btn-secondary btn-block" :disabled="loading">
